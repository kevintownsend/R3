...
#include <stdint.h>
    ...
    int splitCoo(void* coo, uint32 nz, uint64** splitData, double* y, int chunks = 64);
    ...
    int toSpoon(spoonHeader* spoonData, int* row, int* col, double* val, int M, int N, int nnz, int chunks = 64);
